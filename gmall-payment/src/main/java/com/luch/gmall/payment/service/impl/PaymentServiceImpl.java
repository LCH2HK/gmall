package com.luch.gmall.payment.service.impl;
...
import com.luch.gmall.payment.mapper.PaymentInfoMapper;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    @Override
    public void sendPaymentResultCheckDelayQueue(String outTradeNo, int count) {
        Connection connection=null;
        Session session=null;
        try {
            connection = activeMQUtil.getConnectionFactory().createConnection();
